                    ...
                    <div class="summary-wrap">
                        ...
                        <div class="fl">
                            <ul class="btn-choose unstyled">
                                <li>
                                    <a @click="addGoodsToCart()" target="_blank" class="sui-btn  btn-danger addshopcar">加入购物车</a>
                                </li>
                            </ul>
                        </div>
                    </div>
                ...
                <div class="clearfix fitting">
                    ...
                    <div class="good-suits">
                        ...
                        <div class="fr result">
                            ...
                            <button class="sui-btn  btn-danger addshopcar" @click="addGoodsToCart()">加入购物车</button>
                        </div>
                    </div>
                </div>
