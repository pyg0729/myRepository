                        ...
                        <div class="summary-wrap">
                            ...
                            <div class="fl">
                                <ul class="btn-choose unstyled">
                                    <li>
                                        <a @click="submitOrder();queryStatus()" target="_blank"
                    ...
                    <div class="zoom">
                        ...
                        <div id="preview" class="spec-preview">
                            <span class="jqzoom"><img
                                    jqimg="http://192.168.25.129/group1/M00/00/03/wKgZhVqbqY6APfY1AAGcFHQ7Ggg520.jpg"
                                    src="http://192.168.25.129/group1/M00/00/03/wKgZhVqbqY6APfY1AAGcFHQ7Ggg520.jpg"
